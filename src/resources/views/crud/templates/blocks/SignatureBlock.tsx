...
const SignatureBlock: React.FC<BlockContentComponentPorps> = ({
  ...
  useEffect(() => {
    ...
    if (isUpdatingRef.current) {
      // console.log(
      //   `⏸️ SignatureBlock: Skipping update - isUpdatingRef.current is true`
      // );
      return;
    }
    ...
    if (configStateHash === lastConfigStateRef.current) {
      // console.log(
      //   `⏸️ SignatureBlock: Skipping update - configStateHash unchanged`
      // );
      return;
    }

    // console.log(`🔄 SignatureBlock: Processing configState change`);
  ...
  const removeSignatureBlock = useCallback(
    ...
    [localState, updateLocalStable, currentBlock, actions, identifier]
  );
  ...
  }, [currentContent, staff, localContentState?.approval, localState, blockId]);
